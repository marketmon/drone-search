    ...
    <div className="min-h-screen bg-white text-black relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6">
        <div className="max-w-5xl w-full">
          ...
          <div className="border-2 border-black bg-white p-16 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <Link href="/">
                <Button
                  size="lg"
                  className="w-full h-32 text-xl px-8 bg-blue-600 text-white hover:bg-blue-700 rounded-none font-mono tracking-wider border-2 border-blue-600 transition-all hover:translate-x-2 hover:translate-y-2 hover:shadow-[-8px_-8px_0px_0px_rgba(37,99,235,1)] flex flex-col items-center justify-center gap-3"
                >
              ...
              <Link href="/scaleforgeusa/markets">
                <Button
                  size="lg"
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="text-xs text-gray-500 font-sans tracking-normal">Future verticals</div>
                  </div>
                </Button>
              </Link>
            </div>
          ...
          {/* Attribution footer */}
          <div className="mt-8 text-center mb-3 space-y-2">
            <div className="flex gap-4 justify-center text-xs font-mono tracking-wider">
              <Link href="/scaleforgeusa/about" className="text-gray-600 hover:text-black transition-colors">
                ABOUT
              </Link>
